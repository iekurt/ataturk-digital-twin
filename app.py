...
app = FastAPI(
    ...
    description="Constitutional cognition engine, HOPEtensor architecture, Vicdan layer, Streaming SSE, OpenAI TTS, Session Memory Node, Observer Audit Node.",
    version="1.2.0",
)
...
LLM motoru geçici olarak fallback modunda. FastAPI arayüzü, streaming endpoint, health endpoint, Session Memory Node, Vicdan katmanı, HOPEtensor routing contract ve Observer / Audit Node operasyonel durumdadır."""
